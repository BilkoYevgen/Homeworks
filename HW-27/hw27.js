// 1. Додати на раніше створену сторінку кнопки “Додати в друзі”, “Написати повідомлення”, “Запропонувати роботу”.
...
var friendCount = Math.floor(Math.random() * 100) + 1;

var addFriendBtn = document.getElementById("addFriendBtn");
var friendCountSpan = document.getElementById("friendCount");
